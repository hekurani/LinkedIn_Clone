...
function ChatPage({ user = null, onCloseChat = () => {}, chatRoomId = null }) {
  ...
  const handleKeyDown = (e) => {
    if (e.key === "Enter") {
      //nese e type enter me dergu message
      e.preventDefault();
      handleMessageSubmit();
    }
  };
  ...
  return (
    ...
    >
      ...
      <div
        className="h-12  w-72 ml-2 mt-1 p-1.5 mt-2 rounded-md"
      ...
      <div className=" h-13 mt-4 flex justify-center items-center">
        ...
        <div className="ml-auto ">
          <button
            className=" rounded-full font-semibold text-white pl-3 pr-3  mt-1 pb-1 mr-3"
            style={{ backgroundColor: "#0a66c2", outline: "none" }}

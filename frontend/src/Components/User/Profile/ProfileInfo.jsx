...
const ProfileInfo = ({user}) => {
    ...
    <div className='main ml-20 mt-7 rounded-md' style={{border:'1px solid blue',width:'804px'}}>
            ...
            <div className='profileInfo flex mt-16 mb-5 '>
                <div className='personalInfo text-left ml-7'>
                    <p className='font-semibold text-2xl'>Ferat Gashi</p>
                    <p>Software Developer</p>
                    <p className='location mt-1 text-sm 'style={{color:'grey'}}> Pristina, District of Pristina, Kosovo Contact info </p>
                    <p className='connection font-semibold text-sm mt-1' style={{color:'#0a66c2'}}> 500+ connections </p>
 {/*                    <div className='mutal-connections flex relative mt-1'>
                    ...
                    <div className='mt-2'>
                        <button className='rounded-full w-24 p-1 font-semibold' style={{color:'white',backgroundColor:'#0a66c2'}}>Open to</button>
                        <button className='rounded-full ml-2 pb-1 pt-1 pl-3 pr-3 font-semibold' style={{color:'#0a66c2',border:' 1px solid #0a66c2',borderTop:'1.5px solid #0a66c2'}}>Add profile section</button>
                        <button className='rounded-full ml-2
                         pb-1 pt-1 pl-3 pr-3 font-semibold' style={{color:'grey',border:' 1px solid black',borderTop:'1.5px solid black'}}>More</button>
                    </div>
                    
                </div>
                <ul className='experience ml-auto mr-40 '>
                    <li className='flex'>
                    <img src={profile} style={{width:'32px',height:'32px'}} className="CompanyImg " alt={'profile'} />

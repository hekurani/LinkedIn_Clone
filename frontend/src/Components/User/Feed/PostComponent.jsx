...
const PostComponent = ({ user }) => {
  ...
  return (
    ...
    <div className='ml-16 mt-8 rounded-md' style={{ border: '1px solid black',marginBottom:'20px' }}>
        ...
        <div key={index} className='mb-4'>
          ...
          <div className='Reaction flex justify-around m-3'>
            <button className='flex'>
              <svg id="thumbs-up-outline-medium" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" role="none" data-supported-dps="24x24" fill="currentColor">

    ...
    <div className='main fixed inset-0 flex items-center justify-center' style={{ zIndex: 50 }}>
      <div className='w-96 h-96 rounded shadow-2xl' style={{ backgroundColor: 'white', width: '700px', height: '90vh' }}>
        <div className='header m-7 flex'>
          ...
          <button className='ml-auto text-2xl mb-5' ><FontAwesomeIcon icon={faTimes} onClick={closeModal}></FontAwesomeIcon></button>
        </div>

        <div> {/* message */}
          <textarea className='w-full h-32 p-2 pl-3 break-all resize-none text-lg'
            value={description}
            type="text"
        ...
        <div>{/* upload image /create event / occasion */}
          <label htmlFor="imageInput" className='ml-5 text-lg font-semibold text-black-50'>
            <FontAwesomeIcon icon={faImage} style={{ color: 'grey' }} height={10} />
          </label>
          <input
            type="file"
            id="imageInput"

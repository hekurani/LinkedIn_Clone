    ...
    <div className="page h-96" style={{ height: "800px" }}>
      ...
      <div className="form w-96 h-96 mt-6 mx-auto">
        ...
        <div className="credentials m-5">
          ...
          <form
            className="bg-white w-96 h-200 rounded-lg p-5 pl-6"
          ...
          >
            ...
            <br></br>
            <p className="mt-2  text-left" style={{ fontSize: "14px" }}>
              To secure your account, choose a strong password you haven’t used
              before and is at least 8 characters long.
            </p>
            <p style={{ fontSize: "13px", color: "#0a66c2" }}>
              What makes a strong passsword?
            </p>
            <input
              style={{ border: "1px solid black" }}
              className=" p-2 pl-3  mt-7 w-80 rounded h-12"

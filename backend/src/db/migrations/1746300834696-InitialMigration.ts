...
export class InitialMigration1746300834696 implements MigrationInterface {
    name = 'InitialMigration1746300834696'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "company" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "slug" character varying NOT NULL, "industry_type" "public"."company_industry_type_enum" NOT NULL, "Specalities" text, "tagLine" character varying, "logo" character varying NOT NULL DEFAULT 'logo.png', "imageCover" character varying NOT NULL DEFAULT 'imageCover.png', "url" character varying, "phone_number" character varying NOT NULL, "yearFounded" character varying NOT NULL, "workPlace" "public"."company_workplace_enum", "hashTags" text, "createdAt" date NOT NULL DEFAULT ('now'::text)::date, "cityIdId" integer, "ownerId" integer, CONSTRAINT "UQ_a76c5cd486f7779bd9c319afd27" UNIQUE ("name"), CONSTRAINT "UQ_47216baa0f0c8ebc6ee5a74989c" UNIQUE ("slug"), CONSTRAINT "PK_056f7854a7afdba7cbd6d45fc20" PRIMARY KEY ("id"))`);
